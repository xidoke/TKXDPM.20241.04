...
namespace AIMS.Views
{
    public partial class HomeView : UserControl
    {
        ...
        private async void HomeView_Load(object sender, EventArgs e)
        {
            ...
            flpNavBar.Show();
            await mediaController.LoadMediaListbyCategory(Instance.flpDVD, "DVD", "productMiniCard");
            await mediaController.LoadMediaListbyCategory(Instance.flpCD, "CD", "productMiniCard");
            await mediaController.LoadMediaListbyCategory(Instance.flpBook, "Book", "productMiniCard");
        }
