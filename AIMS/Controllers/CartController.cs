...
namespace AIMS.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IMediaRepository mediaRepository, IHttpContextAccessor httpContextAccessor) 
        {
        ...
        {
            var cart = GetCartFromSession();
            var itemToUpdate = cart.FirstOrDefault(i => i.MediaID == productId);
