...
namespace AIMS.Views.Product
{
    public partial class DVDDetailsView : UserControl
    {
        ...
        public DVDDetailsView(int mediaID, MediaController mediaController, CartController cartController, NavBar navBar,
            AddressController addressController, PlaceOrderController placeOrderController)
        {
            InitializeComponent();
            Instance = this;
